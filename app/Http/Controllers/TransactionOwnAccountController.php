...
class TransactionOwnAccountController extends Controller
{
    private function validateTransaction($source_account_id,$target_account_id,$amount){
        ...
        if($target_account->user_id != auth()->user()->id):
            $data[0]=true;
            $data[1]='La cuenta de destino no pertenece al usuario actual.';
            return $data;
        endif;
    ...
    public function create(){
        ...
        return view('transaction.own_account.index', $data);
    }
